...
console.log(JSON.stringify(user));
  ...
  function addCollaborators() {
    console.log('ADD NEW USER OR COLLABORATER',   location.state.project._id,
  ...
  const socket =  initializeSocket(project._id);
    console.log("project id or object :", project);
...
const handler= (data) => {
    ...
    axios
      .get("/user/get-all")
      .then((res) => {
        console.log('here is  get userList ',res.data)
  ...
  // return () => {
  //   const s = getSocket();
  //   if (s) s.off("project-message", handler); // cleanup
  // };
        ...
        <div className="conversation-area pt-14 pb-10 flex-grow flex flex-col h-full relative">
          ...
          >
            {messages.map((msg, index) => (
              ...
              >
                {console.log('currentUserId:', user._id, 'senderId:')}
                {console.log(`msg is ${msg}  and sender is ${msg.sender}   userid id ::${user._id}    `)}
